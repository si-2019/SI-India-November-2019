...
let inicijalniAktivni ={ispiti_info:[], ispiti: [{ key: 0, predmet: "Vjestacka inteligencija", tip: "Prvi parcijalni", datum: "10.2.2019. 13:00", aktivan: 1, prijavljen: 1, popunjen: 0 },
...
let inicijalniPrijavljeni ={ispiti_info:[], ispiti: [{ key: 0, predmet: "Vjestacka inteligencija", tip: "Prvi parcijalni", datum: "10.2.2019. 13:00", aktivan: 1, prijavljen: 1, popunjen: 0 },
        ...
        Alert.alert(
            ...
            [
              { text: "Da", onPress: () => {
                ...
                if(ispit.popunjen)
                    inicijalniAktivni.ispiti[j].popunjen = 0;
